...
const HealthRecordEditScreen = ({ recordId: rawRecordId }: { recordId?: string }): ReactElement => {
          ...
          <HealthRecordForm
            ...
            onSubmit={(values) =>
              updateRecord(toUpdateBody(values), {
                onSuccess: () => router.replace(routes.healthDetail(recordId)),
              })
            }
          />
        )}
...
export default HealthRecordEditScreen
